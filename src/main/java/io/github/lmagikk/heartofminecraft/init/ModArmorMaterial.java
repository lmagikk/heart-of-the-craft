...
public class ModArmorMaterial implements ArmorMaterial {
    ...
    public ModArmorMaterial(int[] defenseForType, int[] durabilityForType, int enchantability, SoundEvent equipSound, Supplier<Ingredient> repairMaterial, String name, float toughness, float knockbackResistance) {
        this.defenseForType = defenseForType;
        this.durabilityForType = durabilityForType;
        this.enchantability = enchantability;
        this.equipSound = equipSound;
        this.repairMaterial = repairMaterial;
        this.name = HeartofMinecraft.MODID + ":" + name;
